    ...
    <div class="p-4 sm:ml-64 pt-20 h-full">
        <section class="p-5 overflow-y-auto mt-5">
                ...
                <div class="layout lg:flex grid grid-cols-1 lg:mt-0 mt-5 justify-end gap-5">
                    <nav class="flex" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="{{ route('pengeluaran.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">List Pengeluaran</a>
                            </div>
                        </li>
            ...
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
                <form action="{{ route('pengeluaran.store') }}" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <x-input-default name="nominal" class="nominal" id="nominal" type="text" value="{{ old('nominal') }}" placeholder="Masukkan data"></x-input-default>
                        </div>
                        <div class="col-span-2">
                            <x-label-default for="">Keterangan </x-label-default>
                            <x-input-textarea rows="4" name="keterangan" type="text" value="{{ old('keterangan') }}" placeholder="Masukkan Keterangan">{{ old('keterangan') }}</x-input-textarea>
                        </div>
                    </div>
                    <hr>
